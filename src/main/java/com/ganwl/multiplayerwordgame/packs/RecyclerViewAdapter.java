...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(ArrayList<Pack> myDataset, Context context) {
        mDataset = myDataset;
        ...
        if (mDataset.get(position).getIsLocked()) {
            ...
            holder.container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    lockedDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        @Override
            ...
            holder.container.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    packClicked(holder.getAdapterPosition());
                }
            });
        }
    }
    ...
    public void packClicked(int position) {
